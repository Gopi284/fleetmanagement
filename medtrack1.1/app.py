...
app = Flask(__name__)
app.secret_key = '2b2842fc0e20652890f6515ddddce40b825b8493b346a0a632b68e10001fb9a0'
...
SNS_TOPIC_ARN = 'arn:aws:sns:us-east-1:545009839820:Medtrack'  # <-- Replace with your real ARN
